...
8. Com o ambiente virtual ativado, instale a biblioteca para interagir criar a API

    ```powershell
    pip install "fastapi[standard]"
    ```

9. Crie um arquivo `app.py` 
    ...
    @app.get('/despesas')
    def listar_despesas():
        ... # Chamar função para interagir com banco de dados.
    ```

## Implementando Features

10. Crie um arquivo `despesas.py`.

### Listando Despesas

11. Implemente uma função chamada "listar" no modulo "despesas" que deve utilizar o comando "SELECT" para buscar as despesas do banco de dados.
...
12. Utilize essa função no arquivo `app.py`

### Cadastrando Despesas

13. Implemente uma função chamada "cadastrar" no modulo de despesas, essa função deve receber "nome", "valor", "descricao" e "data_pagamento", e dentro dela você deve utilizar o comando "INSERT" para criar um novo registro no banco de dados.
